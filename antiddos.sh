...
# Author: Mitul Playz | Enhanced Edition
...
function show_usage() {
    ...
    echo -e "  sudo ./antiddos.sh                                     Launch interactive menu directly (Default)"
...
# Default to launching interactive menu if no command is passed
case "$1" in
    ""|menu)    run_menu ;;
